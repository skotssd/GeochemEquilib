function R = code1_FB_main_debugged(pHvals, FeT, PT, NaT, ClT, ...
                                  HFOsi, HFOwi, ASFs, ASFw,peIN)
% code1_FB_main_debug2:
%   Version 
%   without damping and with maxIterSpec=100 
%
%   R = code1_FB_main_debug(pHvals, FeT, PT, NaT, ClT, HFOsi, HFOwi, ASFs, ASFw,peIN)
%
% Inputs:
...
%
% Use in jupyter:
%   results = code1_FB_main_debug(pHvals, FeT, PT, NaT, ClT, HFOsi, HFOwi, ASFs, ASFw,peIN);
